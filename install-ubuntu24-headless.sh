#!/usr/bin/env bash
# opencv-gpu headless — Ubuntu 24.04 / Python 3.12
# Builds OpenCV (Headless) with CUDA 8.9 (RTX 4080 Super) + cuDNN + NumPy 2 support from source.
set -euo pipefail
...
echo ""
echo -e "${BOLD}opencv-gpu (Headless) — Ubuntu 24.04 / Python ${PYTHON_VER}${NC}"
echo ""
